...
namespace ProyectoAplicadaI.BLL
{
    public class EmpeñosBLL
    {
        ...
        public static bool Modificar(Empeños empeño)
        {
            ...
            try
            {
                var recibos = EmpeñosBLL.Buscar(empeño.EmpeñoId);
                if (recibos != null)
                {
        ...
        public static bool ModificarEspecial(Empeños recibo)
        {
            ...
            try
            {
                Empeños Anterior = BLL.EmpeñosBLL.Buscar(recibo.EmpeñoId);
                decimal diferencia;
                diferencia = Anterior.Abono - recibo.Abono;
                Empeños recibos = BLL.EmpeñosBLL.Buscar(recibo.EmpeñoId);
